...
export default function Orders() {
  ...
  const displayedOrders = useMemo(() => {
    ...
    const filtered = orders.filter((order) => (activeTab === 'all' || order.status === activeTab) && (!normalizedSearch || `${order.retailer_name || ''} ${order.retailer_shop || ''}`.toLowerCase().includes(normalizedSearch)))
