    ...
    <article className={`group overflow-hidden rounded-2xl border bg-white shadow-sm transition duration-200 hover:-translate-y-0.5 hover:shadow-md ${product.active ? 'border-slate-200' : 'border-slate-200 opacity-75'}`}>
      ...
      <div className="p-4">
        ...
        <div className="mt-4 grid grid-cols-2 gap-2">
          <button onClick={onToggle} className="inline-flex items-center justify-center gap-1.5 rounded-lg border border-slate-200 px-2 py-2 text-xs font-bold text-slate-600 transition hover:bg-slate-50">Toggle</button>
          <button onClick={onDelete} className="inline-flex items-center justify-center gap-1.5 rounded-lg border border-rose-200 px-2 py-2 text-xs font-bold text-rose-700 transition hover:bg-rose-50">Delete</button>
        </div>
      </div>
    </article>
  )
